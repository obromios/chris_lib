...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency 'actionview', '~> 5.1', '>= 5.2.4.3'
  s.add_development_dependency 'actionpack', '~> 5.2', '>= 5.2.4.6'
  s.add_development_dependency 'loofah', '~> 2.3', '>= 2.3.1'
  s.add_development_dependency 'rails', '~> 5.1', '>= 5.1.4.6'
  s.add_development_dependency 'rspec-rails', '~> 3.7', '>= 3.7.2'
  s.add_development_dependency 'sqlite3', '~> 1.3', '>= 1.3.11'
  s.add_development_dependency 'nokogiri', '~> 1.10', '>= 1.11.4'
  s.add_development_dependency 'rack', '~> 2.0', '>= 2.2.3'
